...
(let (
    (tl1 (adjoin-term (make-term (make-scheme-number 3) (make-scheme-number 3)) (adjoin-term (make-term (make-scheme-number 1) (make-scheme-number 3)) (the-empty-termlist))))
    (tl2 (adjoin-term (make-term (make-scheme-number 2) (make-scheme-number 2)) (adjoin-term (make-term (make-scheme-number 0) (make-scheme-number 2)) (the-empty-termlist))))
)
