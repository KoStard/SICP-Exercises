...
;;; (display (=zero? (make-scheme-number 3))) (newline)
;;; (display (=zero? (make-rational 3 4))) (newline)
;;; (display (=zero? (make-complex-from-real-imag 3 4))) (newline)
;;; (display (=zero? (make-complex-from-mag-ang 3 4))) (newline)

;;; (display (=zero? (make-scheme-number 0))) (newline)
;;; (display (=zero? (make-rational 0 4))) (newline)
;;; (display (=zero? (make-complex-from-real-imag 0 0))) (newline)
;;; (display (=zero? (make-complex-from-mag-ang 0 4))) (newline)
