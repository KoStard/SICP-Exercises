...
(let (
    (tl1 (adjoin-term (make-term 3 (make-scheme-number 3)) (adjoin-term (make-term 1 (make-scheme-number 3)) (the-empty-dense-termlist))))
    (tl2 (adjoin-term (make-term 2 (make-scheme-number 2)) (adjoin-term (make-term 0 (make-scheme-number 2)) (the-empty-dense-termlist))))
)
